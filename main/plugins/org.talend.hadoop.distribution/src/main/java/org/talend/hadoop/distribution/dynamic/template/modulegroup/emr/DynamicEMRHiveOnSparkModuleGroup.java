 ...
 *
 */
public class DynamicEMRHiveOnSparkModuleGroup extends DynamicHiveOnSparkModuleGroup {

    public DynamicEMRHiveOnSparkModuleGroup(DynamicPluginAdapter pluginAdapter) {
        super(pluginAdapter);
    }
