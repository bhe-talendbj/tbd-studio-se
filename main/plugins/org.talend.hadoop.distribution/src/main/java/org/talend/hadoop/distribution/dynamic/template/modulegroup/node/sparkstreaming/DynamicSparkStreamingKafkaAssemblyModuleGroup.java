...
public class DynamicSparkStreamingKafkaAssemblyModuleGroup extends AbstractNodeModuleGroup {

    protected ComponentCondition spark1Condition;

    protected ComponentCondition spark2Condition;

    public DynamicSparkStreamingKafkaAssemblyModuleGroup(DynamicPluginAdapter pluginAdapter) {
        super(pluginAdapter);
        init();
    }
    ...
    public Set<DistributionModuleGroup> getModuleGroups(String distribution, String version) throws Exception {
        ...
        String spark2KafkaAssemblyMrRequiredRuntimeId = pluginAdapter
                .getRuntimeModuleGroupIdByTemplateId(
                        DynamicModuleGroupConstant.SPARK2_KAFKA_ASSEMBLY_MRREQUIRED_MODULE_GROUP.getModuleName());
