...
import org.talend.hadoop.distribution.dynamic.template.modulegroup.emr.DynamicEMRSparkBatchModuleGroup;
import org.talend.hadoop.distribution.dynamic.template.modulegroup.node.sparkbatch.DynamicSparkBatchKuduNodeModuleGroup;
import org.talend.hadoop.distribution.dynamic.template.modulegroup.node.sparkbatch.emr.DynamicEMRGraphFramesNodeModuleGroup;
 ...
 *
 */
public class DynamicEMRSparkBatchModuleGroupTemplate extends DynamicSparkBatchModuleGroupTemplate {

    public DynamicEMRSparkBatchModuleGroupTemplate(DynamicPluginAdapter pluginAdapter) {
        super(pluginAdapter);
    }

    @Override
    protected Set<DistributionModuleGroup> buildModuleGroups4SparkBatch(DynamicPluginAdapter pluginAdapter) throws Exception {
        return new DynamicEMRSparkBatchModuleGroup(pluginAdapter).getModuleGroups();
    }
    ...
    protected Set<DistributionModuleGroup> buildNodeModuleGroups4SparkBatch4GraphFrames(DynamicPluginAdapter pluginAdapter,
        ...
        return new DynamicEMRGraphFramesNodeModuleGroup(pluginAdapter).getModuleGroups(distribution, version);
    }
